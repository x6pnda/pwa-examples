...
export const makeFetchRequest = async <T>(url: string, section: string, options?: RequestInit, searchParams?: Record<string, string>): Promise<IFetchResult<T>> => {
...
export const $fetch = async <T>(
    ...
    try {
        ...
        // eslint-disable-next-line
        throw { data: undefined, code: 500, message: 'Error', success: false };
    }
};
